...
isEmpty(VVERSION) {
    # Qt 3 
     TARGET    = klayoutplugin
     CONFIG   += qt warn_on thread release plugin

     UI_DIR    = ui

    HEADERS  += klayoutplugin.h
    SOURCES  += klayoutplugin.cpp
    ...
    TARGET    = klayout_designer_plugin
    ...
    HEADERS  += klayout_designer_plugin.h
    SOURCES  += klayout_designer_plugin.cpp
