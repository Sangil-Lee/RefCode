    ...
    QwtPlot(parent)
{
    ...
    setAxisScale(QwtPlot::xBottom, -100.0, 100.0);
    ...
    insertCurve(Qt::Horizontal, Qt::white, 0.0);
...
void InteractivePlot::initInteractivePlot()
{
	//(void) new CanvasPicker(this);
	canvasPicker = new CanvasPicker(this);
	scalePicker = new ScalePicker(this);
	connect(scalePicker, SIGNAL(clicked(int, double)), this, SLOT(insertCurve(int, double)));
	replot();
}

void InteractivePlot::setCanvasColor(const QColor &c)
{
    setCanvasBackground(c);
    replot();
}

void InteractivePlot::scrollLeftAxis(double value)
{
    setAxisScale(yLeft, value - 100.0, value + 100.0);
    replot();
}

bool InteractivePlot::eventFilter(QObject *object, QEvent *e)
{
...
void InteractivePlot::insertCurve(int axis, double base)
{
    Qt::Orientation o;
...
void InteractivePlot::insertCurve(Qt::Orientation o,
...
QwtData& InteractivePlot::getData() const
{
	return (QwtData&) canvasPicker->getData();
}
