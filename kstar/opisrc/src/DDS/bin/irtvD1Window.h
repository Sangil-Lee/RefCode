#ifndef IRTV_D1_WINDOW_H
#define IRTV_D1_WINDOW_H

#include "irtvMainWindow.h"
#include "ui_DDS_IRTV_D1.h"

class IRTV_D1Window : public QObject, 
	public IRTV_MainWindow, public IRTV_Interface, public Ui::IrtvD1Window
{
    Q_OBJECT
public:
    IRTV_D1Window (QWidget *parent = 0);
    ~IRTV_D1Window ();
...
public slots:
	...
	// Trigger Mode
	void on_radio_TriggerMode_Free_clicked ();
	void on_radio_TriggerMode_Trig_Seq_clicked ();
	void on_radio_TriggerMode_Trig_Free_clicked ();
	void on_radio_TriggerMode_External_clicked ();
