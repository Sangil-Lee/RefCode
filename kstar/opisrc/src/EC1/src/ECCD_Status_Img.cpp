...
ECCD_Status_Img::ECCD_Status_Img(QWidget *parent)
    : QWidget(parent)
{
	ui.setupUi(this);
...
ECCD_Status_Img::~ECCD_Status_Img()
{
//	if(ui.label) {delete ui.label; ui.label = NULL; }
}

void ECCD_Status_Img::slot_MODECHANGE(bool bMode){
	bKMode = bMode;
	//if (bMode==true)
	if (bMode==false)	//2011-07-19 by son
	{    ui.lbLine01->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line01_k_1.png")));
	     ui.lbLine02->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line02_k.png")));
	      if (bRFGV==false)
	...
	{
		ui.lbLine01->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line01_d_1.png")));
		ui.lbLine02->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line02_d.png")));
		ui.lbslauncher->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_s_launcher.png")));
	}
}

void ECCD_Status_Img::slot_MODECHANGE2(bool bMode){
	bKMode2 = bMode;
	//if (bMode==true)
	if (bMode==false)	//2011-07-19 by son
	{    ui.lbLine01_1->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line01_1_k_1.png")));
	     ui.lbLine02_1->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line02_1_k.png")));

	}
	else
	{    ui.lbLine01_1->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line01_1_d_1.png")));
	     ui.lbLine02_1->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_line02_1_d.png")));
	}
}

void ECCD_Status_Img::slot_RFGVCHANGE(bool bMode){
 	bRFGV = bMode;
	if (bMode==false)
	{    if (bKMode==true)
		{ui.lbslauncher->setPixmap(QPixmap(QString::fromUtf8("/usr/local/opi/images/ECCD_s_launcher_o.png")));}
...
void ECCD_Status_Img::slot_RFGVCHANGE2(bool bMode){
 	bRFGV2 = bMode;
}


int ECCD_Status_Img::slot_TMP1_Stat_Desc(double dStatus){
...
int ECCD_Status_Img::slot_TMP2_Stat_Desc(double dStatus){
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 7) iStat = 0;
	switch(iStat)
	{
...
int ECCD_Status_Img::slot_TMP3_Stat_Desc(double dStatus){
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 7) iStat = 0;
	switch(iStat)
	{
...
int ECCD_Status_Img::slot_TMP4_Stat_Desc(double dStatus){
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 7) iStat = 0;
	switch(iStat)
	{
...
void ECCD_Status_Img::slot_VGV1_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
...
int ECCD_Status_Img::slot_TMP5_Stat_Desc(double dStatus){
	int iStat = int(dStatus);
...
void ECCD_Status_Img::slot_VGV2_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 2) iStat = 2;
	switch(iStat)
...
void ECCD_Status_Img::slot_VGV3_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 2) iStat = 2;
	switch(iStat)
...
void ECCD_Status_Img::slot_VGV4_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 2) iStat = 2;
	switch(iStat)
...
void ECCD_Status_Img::slot_VGV5_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 2) iStat = 2;
	switch(iStat)
...
void ECCD_Status_Img::slot_WG2_Stat_Change1(double dStatus)
{
	int iStat = int(dStatus);
	if(iStat < 0 && iStat > 2) iStat = 2;
...
void ECCD_Status_Img::slot_WG3_Stat_Change1(double dStatus)
{
