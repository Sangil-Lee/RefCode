#ifndef ECCD_Status_Img_H
#define ECCD_Status_Img_H

#include <QtGui/QWidget>
#include "ui_ECCD_Status_Img.h"
#include "qtchaccesslib.h"

class ECCD_Status_Img : public QWidget
{
    Q_OBJECT

public:
    ECCD_Status_Img(QWidget *parent = 0);
    ~ECCD_Status_Img();
