...
#XML-RPC // we do not use this archivesheet. so remove this function at 2011.03.10
...
#LIBS += -L/usr/local/opi/lib -larchivesheet -lmultiplot -lpvlistviewer // we do not use this archivesheet. so remove this larchivesheet at 2011.03.10
