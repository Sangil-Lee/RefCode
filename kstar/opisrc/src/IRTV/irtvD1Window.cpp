...
IRTV_D1Window::IRTV_D1Window (QWidget *parent)
{
...
IRTV_D1Window::~IRTV_D1Window ()
{
}

void IRTV_D1Window::init ()
{
#if !defined(WIN32)
	...
	try {
		...
		pWnd->printStatus ("[IRTV_D1Window::init] shared memory open failed. %s", shmErr.getReason());
	}
#endif
...
void IRTV_D1Window::createActions ()
{
}

void IRTV_D1Window::createConnects ()
{
	...
	// Radio button for Trigger Mode
	connect (radio_TriggerMode_Free, SIGNAL(clicked()), this, SLOT(on_radio_TriggerMode_Free_clicked()));
	connect (radio_TriggerMode_Trig_Free, SIGNAL(clicked()), this, SLOT(on_radio_TriggerMode_Trig_Free_clicked()));
	connect (radio_TriggerMode_Trig_Seq, SIGNAL(clicked()), this, SLOT(on_radio_TriggerMode_Trig_Seq_clicked()));
	connect (radio_TriggerMode_External, SIGNAL(clicked()), this, SLOT(on_radio_TriggerMode_External_clicked()));
...
void IRTV_D1Window::updateWindowCoordi ()
{
	// ROI 설정 값 변경
...
void IRTV_D1Window::setWindowCoordi (char *x, char *y, char *width, char *height)
{
...
void IRTV_D1Window::on_btn_FileDialog_clicked ()
{
...
void IRTV_D1Window::on_btn_RefreshTime_changed ()
{
...
// 서버에 대한 통신 연결 및 해제
void IRTV_D1Window::on_btn_DisplayOnOff_clicked ()
{
...
// ROI View 영역에 이미지 갱신
void IRTV_D1Window::on_btn_UpdateROIView_clicked ()
{
...
void IRTV_D1Window::on_btn_ROIFullScale_clicked ()
{
...
void IRTV_D1Window::on_edit_ROI_Width_changed ()
{
...
void IRTV_D1Window::on_edit_ROI_Height_changed ()
{
...
void IRTV_D1Window::on_slider_FrameRate_changed ()
{
...
void IRTV_D1Window::on_table_StoredNUC_cellClickd (int row, int col)
{
	...
	if (item) {
		...
		writePV ("IRTV_D1_SEL_NUC_NAME", str);
	}
}

void IRTV_D1Window::on_radio_SyncSource_Free_clicked ()
{
	writePV ("IRTV_D1_SYNC_SOURCE", "0");
}

void IRTV_D1Window::on_radio_SyncSource_SWTrigger_clicked ()
{
	writePV ("IRTV_D1_SYNC_SOURCE", "2");
}

void IRTV_D1Window::on_radio_SyncSource_External_clicked ()
{
	writePV ("IRTV_D1_SYNC_SOURCE", "1");
}

void IRTV_D1Window::on_radio_TriggerMode_Free_clicked ()
{
	writePV ("IRTV_D1_TRIGGER_MODE", "0");
}

void IRTV_D1Window::on_radio_TriggerMode_Trig_Free_clicked ()
{
	writePV ("IRTV_D1_TRIGGER_MODE", "1");
}

void IRTV_D1Window::on_radio_TriggerMode_Trig_Seq_clicked ()
{
	writePV ("IRTV_D1_TRIGGER_MODE", "2");
}

void IRTV_D1Window::on_radio_TriggerMode_External_clicked ()
{
	writePV ("IRTV_D1_TRIGGER_MODE", "3");
}

void IRTV_D1Window::on_radio_PolarityFalling_clicked ()
{
	writePV ("IRTV_D1_SYNC_POLARITY", "0");
}

void IRTV_D1Window::on_radio_PolarityRising_clicked ()
{
	writePV ("IRTV_D1_SYNC_POLARITY", "1");
}

void IRTV_D1Window::on_radio_FPA_Disable_clicked ()
{
	writePV ("IRTV_D1_FPA_COOLER_AUTO", "0");
}

void IRTV_D1Window::on_radio_FPA_Enable_clicked ()
{
	writePV ("IRTV_D1_FPA_COOLER_AUTO", "1");
}

void IRTV_D1Window::on_radio_FPA_Auto_clicked ()
{
	writePV ("IRTV_D1_FPA_COOLER_AUTO", "2");
}

void IRTV_D1Window::on_radio_Preset0_clicked ()
{
	writePV ("IRTV_D1_SEL_PRESET_NUM", "0");
}

void IRTV_D1Window::on_radio_Preset1_clicked ()
{
	writePV ("IRTV_D1_SEL_PRESET_NUM", "1");
}

void IRTV_D1Window::on_radio_Preset2_clicked ()
{
	writePV ("IRTV_D1_SEL_PRESET_NUM", "2");
}

void IRTV_D1Window::on_radio_Preset3_clicked ()
{
	writePV ("IRTV_D1_SEL_PRESET_NUM", "3");
}

void IRTV_D1Window::on_radio_Action_Perform_clicked ()
{
	writePV ("IRTV_D1_NUC_ACTION_TYPE", "0");
}

void IRTV_D1Window::on_radio_Action_Load_clicked ()
{
	writePV ("IRTV_D1_NUC_ACTION_TYPE", "1");
}

void IRTV_D1Window::on_radio_Action_Unload_clicked ()
{
	writePV ("IRTV_D1_NUC_ACTION_TYPE", "2");
}

void IRTV_D1Window::on_radio_Action_Save_clicked ()
{
	writePV ("IRTV_D1_NUC_ACTION_TYPE", "3");
}

void IRTV_D1Window::startTimer ()
{
	if (NULL == m_QTimer) {
...
void IRTV_D1Window::timerCallback ()
{
	//qDebug ("Timer ... ");
...
void IRTV_D1Window::startTimer_PV ()
{
	if (NULL == m_QTimerPV) {
...
void IRTV_D1Window::timerCallback_PV ()
{
	// 등록된 PV들의 값 얻기 : Stored NUCs 목록 표시
	getCA ();
}

void IRTV_D1Window::updateGrabFrameData ()
{
...
void IRTV_D1Window::displayGrabFrame ()
{
	int	width, height;
...
void IRTV_D1Window::initCA ()
{
	...
	caInfo.name = "IRTV_D1_STORED_NUC_LIST";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_SYNC_SOURCE";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_TRIGGER_MODE";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_SYNC_POLARITY";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_FPA_COOLER_AUTO";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_SEL_PRESET_NUM";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_NUC_ACTION_TYPE";
	m_vCAInfoList.push_back (caInfo);

	caInfo.name = "IRTV_D1_MAX_RATE";
	m_vCAInfoList.push_back (caInfo);
...
void IRTV_D1Window::getCA ()
{
	...
	for (i = 0; i < m_vCAInfoList.size(); i++) {
		...
		if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_STORED_NUC_LIST")) {
			bChanged	= false;
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_SYNC_SOURCE")) {
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_TRIGGER_MODE")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));

			if (0 == strcmp(value, "0")) {
				radio_TriggerMode_Free->setChecked (true);
				radio_TriggerMode_Trig_Free->setChecked (false);
				radio_TriggerMode_Trig_Seq->setChecked (false);
				radio_TriggerMode_External->setChecked (false);
			}
			else if (0 == strcmp(value, "1")) {
				radio_TriggerMode_Free->setChecked (false);
				radio_TriggerMode_Trig_Free->setChecked (true);
				radio_TriggerMode_Trig_Seq->setChecked (false);
				radio_TriggerMode_External->setChecked (false);
			}
			else if (0 == strcmp(value, "2")) {
				radio_TriggerMode_Free->setChecked (false);
				radio_TriggerMode_Trig_Free->setChecked (false);
				radio_TriggerMode_Trig_Seq->setChecked (true);
				radio_TriggerMode_External->setChecked (false);
			}
				...
				radio_TriggerMode_Trig_Free->setChecked (false);
				radio_TriggerMode_Trig_Seq->setChecked (false);
				radio_TriggerMode_External->setChecked (true);
			}
		}
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_SYNC_POLARITY")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_FPA_COOLER_AUTO")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_SEL_PRESET_NUM")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_NUC_ACTION_TYPE")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));
		...
		else if (0 == strcmp (m_vCAInfoList[i].name.c_str(), "IRTV_D1_MAX_RATE")) {
			strcpy (value, val2str (m_vCAInfoList[i].value, m_vCAInfoList[i].dbrType, 0));
