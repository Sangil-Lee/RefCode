...
#XML-RPC
INCPATH     += /usr/local/include/xerces
...
# Input
SOURCES += ../MainWindow.cpp ../ArchiveDataClient.cpp ../main.cpp 
HEADERS += MainWindow.h ArchiveDataCommon.h ArchiveDataClient.h  
RESOURCES += ../pmsarch.qrc
