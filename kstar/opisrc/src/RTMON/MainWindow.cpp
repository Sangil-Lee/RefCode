...
MainWindow::makeUI()
{
	setWindowTitle(QApplication::translate("RTMON test", "RT-MON", 0, QApplication::UnicodeUTF8));
	centralwidget = new QWidget(this);
	centralwidget->setObjectName (QString::fromUtf8("centralwidget"));
	centralwidget->setWindowTitle(QApplication::translate("RTMON test", "Central", 0, QApplication::UnicodeUTF8));
}
...
//	pattach = new AttachChannelAccess("../ui/RMP.ui",1);
	pattach = new AttachChannelAccess("/usr/local/opi/ui/RTMON.ui",1);
