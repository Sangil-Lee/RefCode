...
MainWindow::makeUI()
{
	...
	action_AboutSCS = new QAction(this);
	action_AboutSCS->setObjectName(QString::fromUtf8("action_AboutSCS"));
	connect(action_AboutSCS, SIGNAL(triggered()), this, SLOT(showAboutSCS()));
	...
	*/
    ...
    pushButton[0]->setText(QApplication::translate("MainWindow", "OP Mode", 0, QApplication::UnicodeUTF8));
    ...
    pushButton[1]->setText(QApplication::translate("MainWindow", "Machine Status ", 0, QApplication::UnicodeUTF8));
    ...
    pushButton[2]->setText(QApplication::translate("MainWindow", "Vacuum Pumping", 0, QApplication::UnicodeUTF8));
    ...
    pushButton[3]->setText(QApplication::translate("MainWindow", "Sequential Op.", 0, QApplication::UnicodeUTF8));
    vboxLayout0->addWidget(pushButton[3]);

    spacerItem1 = new QSpacerItem(20, 1, QSizePolicy::Minimum, QSizePolicy::Expanding);
    vboxLayout0->addItem(spacerItem1);

    tabWidget->addTab(tab_0, QApplication::translate("MainWindow", "SCS Main panels", 0, QApplication::UnicodeUTF8));
...
#endif
	menu_Help->addAction(action_AboutSCS);
	...
	*/
	...
	setWindowIcon(QIcon(QString::fromUtf8("/usr/local/opi/images/SCS.xpm")));
...
#endif
    action_AboutSCS->setText(QApplication::translate("MainWindow", "About &SCS", 0, QApplication::UnicodeUTF8));
...
void
MainWindow::showAboutSCS()
{
	QMessageBox *mbox = new QMessageBox();
	mbox->setIconPixmap(QPixmap("/usr/local/opi/images/SCS.xpm"));
	mbox->setWindowTitle("About KSTAR SCS");
	mbox->setText("KSTAR SCS Operator Interface");
...
MainWindow::keyPressEvent(QKeyEvent *event )
{
	...
	if ((modifier==0x14 || modifier == 0x4)&& key == Qt::Key_P)
	{
		...
		QString filename = "/home/kstar/screenshot/SCS_"+curtime+".jpg";
		QString format = "jpg";
