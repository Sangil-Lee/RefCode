...
public:
    ...
    void retranslateUi(QWidget *Form)
	{
		...
		valueInsert->setText("Insert");
		valueApply->setText("Apply");
		label->setText("X-Range");
		label_2->setText("Min");
		label_3->setText("Max");
		label_4->setText("Y-Range");
		label_5->setText("Max");
		label_6->setText("Min");
		valueDelete->setText("Delete");
		label_7->setText("Line Width");
		label_8->setText("Symbol Size");
		label_9->setText("Line Color");

		check_1->setText("X-Nearby");
		check_2->setText("Y-Nearby");

		Pencolor->clear();
		Pencolor->insertItems(0, QStringList()
				<< "Blue" << "Red" << "Yellow" << "Black" << "White");
		label_10->setText("Symbol Color");
		Symbolcolor->clear();
