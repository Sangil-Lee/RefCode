...
public:
	...
	int IsEth2(){return meth2;};
private:
	FILE *mfile;
	unsigned long moldbyteout, moldbytein,meth1oldbyteout,meth1oldbytein,meth2oldbyteout,meth2oldbytein;
	unsigned long mbyteout, mbytein, meth1bytein, meth1byteout, meth2bytein, meth2byteout;
	int monce;
	int meth1;
	int meth2;
