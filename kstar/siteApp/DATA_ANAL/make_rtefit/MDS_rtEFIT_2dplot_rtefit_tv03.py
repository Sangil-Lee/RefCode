...
def run(shot,time_i,time_f,image_ok,treename='EFITRT1'):
   ...
   for i in range(0,len(geqdsk[index_time])):
       ...
       if True:
            ...
            #gs = gridspec.GridSpec(1, 3, width_ratios=[1.38, 1, 1.51]) # not be used because tv01 is out of order.
            gs = gridspec.GridSpec(1, 2, width_ratios=[1, 1.38]) # not be used because tv01 is out of order.
            ...
            #set time ...
            if image_ok == 1:
               print 'File Choice: %d'%int((time*1000)*100/1000)
            ...
            #img2 = image2.crop((80,54,528,566)) #TV01 Image cropping
