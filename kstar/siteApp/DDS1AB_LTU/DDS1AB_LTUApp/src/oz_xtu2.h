...
/*
#define XTU_VENDOR_ID (0x10EE)
#define XTU_DEVICE_ID (0x0007)
#define XTU_LATENCY_TIME (0xf0)
*/
...
Date      : 
*******************************************************************************/
STATUS xtu_GetCompensationTime(ST_drvCLTU * , unsigned int *pCMPST_Time );
...
Date      : 
*******************************************************************************/
STATUS xtu_SetShotTime(ST_drvCLTU * , unsigned int shot_Start_Time, unsigned int shot_Start_Tick, unsigned int shot_End_Time, unsigned int shot_End_Tick);
...
Date      : 
*******************************************************************************/
STATUS ctu_SerdesTxImmediate( ST_drvCLTU * );
...
Date      : 
*******************************************************************************/
STATUS ltu_SetCompensationTime(ST_drvCLTU * , unsigned int timeDelay );
