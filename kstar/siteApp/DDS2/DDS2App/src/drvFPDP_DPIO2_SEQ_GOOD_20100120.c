...
#if 1
	printf(" maxNumPages= %d, PAGE_SIZE= %d\n", maxNumPages, PAGE_SIZE);
#endif
...
#if 0       
/* Remove All init FPDP - TG Lee  2010 0108 */ 
...
/*  Modify Sequence DPIO2 module 20091105  */
  ...
  /* Configure DMA chain. Remove Init Time TG.Lee 
...
int startFpdp()
{
/*  Until Add TG.Lee DPIO2 Sequence - 2010 0107 */
...
*/	
	...
	printf ("Complate Start FPDP to start DMA transfer TG.LEE 20100108\n");
...
/* Free buffer. - DPIO2 Sequence Add TG.Lee 2010 01 07 */
	unlockAndFreeBuffer (pPageInfo_in,  (UINT32 *)buffer_in);
