...
my $IOCBootBaseDir = "/opt/eldk/ppc_74xx/usr/local/epics/siteApp/DDS2/iocBoot/";
# my $IOCBootBaseDir = "/root/ioc/m6802/iocBoot";
...
sub find_boot_iocs {
    ...
    my @candidate_ioc_names = "iocDDS2"; # gets all in cwd
    my @ioc_names = ();
    my @boot_infos = ();
    ...
    foreach $ioc_nm (@ioc_names) {
        ...
        $st_cmd_file = "st.cmd.crawler";  # always this, apparently
