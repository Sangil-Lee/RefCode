...
void func_Dummy_OP_MODE(void *, double, double);
...
void func_Dummy_SAMPLING_RATE(void *, double , double );
void func_Dummy_DATA_SEND(void *, double , double );
...
/********************************************************************************/
{
	...
	pMaster->ST_Func._OP_MODE = func_Dummy_OP_MODE;
	pMaster->ST_Func._BOARD_SETUP = func_Dummy_BOARD_SETUP;
	pMaster->ST_Func._SYS_ARMING= func_Dummy_SYS_ARMING;
	pMaster->ST_Func._SYS_RUN = func_Dummy_SYS_RUN;
	pMaster->ST_Func._DATA_SEND = func_Dummy_DATA_SEND;

//	pMaster->ST_Func._Exit_Call = func_Dummy_Exit_Call;
}
...
void func_Dummy_OP_MODE(void *pArg, double ignore, double ignore1)
{
...
void func_Dummy_BOARD_SETUP(void *pArg, double ignore, double ignore1)
{
...
void func_Dummy_SYS_ARMING(void *pArg, double arg1, double ignore1)
{
...
void func_Dummy_SYS_RUN(void *pArg, double arg1, double ignore)
{
...
void func_Dummy_DATA_SEND(void *pArg, double ignore, double ignore1)
{
