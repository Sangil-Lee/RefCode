#ifndef _EC1_D1_DAQ_DRV_NI6220_H
#define _EC1_D1_DAQ_DRV_NI6220_H
...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"EC1_D1_DAQ_SHOT_NUMBER"
#define PV_SYS_RUN_STR 				"EC1_D1_DAQ_SYS_RUN"
#define PV_SYS_ARMING_STR 			"EC1_D1_DAQ_SYS_ARMING"
#define PV_RESET_STR 				"EC1_D1_DAQ_RESET"
#define PV_DAQ_STOP_STR 			"EC1_D1_DAQ_DAQ_STOP"
...
//TODO
#define INIT_MAX_CHAN_SAMPLES  		500000  /* PXI-6220 Max Rate : 500,000 Hz. so number of sampling data per channel  */
...
typedef struct {
	...
	// for MDSplus for calcuration
	char		inputTagNameCalc[40];	// 
	char		strTagNameEu[40];		// 
	char		strTagNameCalc[40];		// 
	FILE		*write_fp_calc;			// calcuration
...
typedef struct {
	...
	ST_NI6220_channel ST_Ch[INIT_MAX_CHAN_NUM];
...
extern float64 getTotSampsChan (ST_NI6220 *pNI6220);
...
#endif	// _EC1_D1_DAQ_DRV_NI6220_H
