...
static long
initSiNiPci6220Record(void *prec)
{
...
static long
initSoNiPci6220Record(void *prec)
{
...
static long
initLiNiPci6220Record(void *prec)
{
...
static long
initLoNiPci6220Record(void *prec)
{
...
static struct {
    ...
    long (*read)(void *);
    long (*special_linconv)(void *,int);
} devSiNiPci6220 = { 6, NULL, NULL, initSiNiPci6220Record, NULL, readSiNiPci6220, NULL };

epicsExportAddress(dset,devSiNiPci6220);
...
static struct {
    ...
    long (*write)(void *);
    long (*special_linconv)(void *,int);
} devSoNiPci6220 = { 6, NULL, NULL, initSoNiPci6220Record, NULL, writeSoNiPci6220, NULL };

epicsExportAddress(dset,devSoNiPci6220);
...
static struct {
    ...
    long (*read)(void *);
    long (*special_linconv)(void *,int);
} devLiNiPci6220 = { 6, NULL, NULL, initLiNiPci6220Record, NULL, readLiNiPci6220, NULL };

epicsExportAddress(dset,devLiNiPci6220);
...
static struct {
    ...
    long (*write)(void *);
    long (*special_linconv)(void *,int);
} devLoNiPci6220 = { 6, NULL, NULL, initLoNiPci6220Record, NULL, writeLoNiPci6220, NULL };

epicsExportAddress(dset,devLoNiPci6220);
