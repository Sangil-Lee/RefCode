...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"ECEHR_SHOT_NUMBER"
#define PV_SYS_ARMING_STR 		"ECEHR_SYS_ARMING"
#define PV_SYS_RUN_STR			"ECEHR_SYS_RUN"
#define PV_LTU_TIG_T0_STR		"VBS_LTU_P2_SEC0_T0"
#define PV_START_TIG_T0_STR		"ECEHR_START_T0_SEC1"
#define PV_STOP_TIG_T1_STR		"ECEHR_STOP_T1_SEC1"
#define PV_RESET_STR 			"ECEHR_RESET"

#define PV_CALC_RUN_STR 		"ECEHR_CALC_RUN"
#define PV_TREND_RUN_STR 		"ECEHR_TREND_RUN"
#define PV_DAQ_STOP_STR 		"ECEHR_DAQ_STOP"
...
#define INIT_SAMPLE_RATE		100000		// ECEHR default 100,000Hz
...
#define STR_CH_MAPPING_FILE    "/usr/local/epics/siteApp/ECEHR/acq196_ch_mapping"
#define STR_CH_VIN_FILE        "/usr/local/epics/siteApp/ECEHR/acq196_ch_vin"
...
typedef struct {
	...
	float64		teValue;				// Electron templature : (euValue - teOffset) * calFactor
	float64		teOffset;				// Electron templature : teOffset, just firset raw value (Not use avr value)
