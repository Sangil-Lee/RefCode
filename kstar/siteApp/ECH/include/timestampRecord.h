...
typedef struct timestampRecord {
	...
	unsigned long	sec;	/*Value (Seconds)*/
	unsigned long	nsec;	/*Value (Nanoseconds)*/
	unsigned long	rval;	/*Current Raw Value*/
...
#define timestampRecordSEC	45
#define timestampRecordNSEC	46
#define timestampRecordRVAL	47
#define timestampRecordTST	48
#endif /*INCtimestampH*/
...
static int timestampRecordSizeOffset(dbRecordType *pdbRecordType)
{
  ...
  pdbRecordType->papFldDes[45]->size=sizeof(prec->sec);
  pdbRecordType->papFldDes[45]->offset=(short)((char *)&prec->sec - (char *)prec);
  pdbRecordType->papFldDes[46]->size=sizeof(prec->nsec);
  pdbRecordType->papFldDes[46]->offset=(short)((char *)&prec->nsec - (char *)prec);
  pdbRecordType->papFldDes[47]->size=sizeof(prec->rval);
  pdbRecordType->papFldDes[47]->offset=(short)((char *)&prec->rval - (char *)prec);
  pdbRecordType->papFldDes[48]->size=sizeof(prec->tst);
  pdbRecordType->papFldDes[48]->offset=(short)((char *)&prec->tst - (char *)prec);
