...
static void devNI6123_AO_CONSTANT_A(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_CONSTANT_A] %s : ch(%d) density constant A(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].conA = pParam->setValue;

	scanIoRequest(pSTDdev->ioScanPvt_userCall); 			
}
static void devNI6123_AO_CONSTANT_B(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_CONSTANT_B] %s : ch(%d) density constant B(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].conB = pParam->setValue;

	scanIoRequest(pSTDdev->ioScanPvt_userCall); 			
}
static void devNI6123_AO_CONSTANT_C(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_CONSTANT_C] %s : ch(%d) density constant C(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].conC = pParam->setValue;
...
static void devNI6123_AO_MDS_PARAM_VALUE1(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_MDS_PARAM_VALUE1] %s : ch(%d) MDSplus Param value(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].mdsParam1 = pParam->setValue;

	scanIoRequest(pSTDdev->ioScanPvt_userCall); 			
}
static void devNI6123_AO_MDS_PARAM_VALUE2(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_MDS_PARAM_VALUE2] %s : ch(%d) MDSplus Param value(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].mdsParam2 = pParam->setValue;

	scanIoRequest(pSTDdev->ioScanPvt_userCall); 			
}
static void devNI6123_AO_MDS_PARAM_VALUE3(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_MDS_PARAM_VALUE3] %s : ch(%d) MDSplus Param value(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].mdsParam3 = pParam->setValue;

	scanIoRequest(pSTDdev->ioScanPvt_userCall); 			
}
static void devNI6123_AO_MDS_PARAM_VALUE4(ST_execParam *pParam)
{
	ST_STD_device *pSTDdev = pParam->pSTDdev;
	ST_NI6123 *pNI6123 = pSTDdev->pUser;
	int	chId;
	...
	kLog (K_TRACE, "[devNI6123_AO_MDS_PARAM_VALUE4] %s : ch(%d) MDSplus Param value(%f)\n",
			pSTDdev->taskName, chId, pParam->setValue);

	pNI6123->ST_Ch[chId].mdsParam4 = pParam->setValue;
