#ifndef _NB1A_DRV_NI6123_H
#define _NB1A_DRV_NI6123_H
...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"ECH_SHOT_NUMBER"
#define PV_SYS_ARMING_STR 		"ECH_SYS_ARMING"
#define PV_SYS_RUN_STR			"ECH_SYS_RUN"
#define PV_LTU_TIG_T0_STR		"ECH_LTU_T0_p2"
#define PV_START_TIG_T0_STR		"ECH_START_T0_SEC1"
#define PV_STOP_TIG_T1_STR		"ECH_STOP_T1_SEC1"
#define PV_RESET_STR 			"ECH_RESET"

#define PV_CALC_RUN_STR 		"ECH_CALC_RUN"
#define PV_TREND_RUN_STR 		"ECH_TREND_RUN"
#define PV_DAQ_STOP_STR 		"ECH_DAQ_STOP"
...
#define INIT_MAX_CHAN_NUM		16	/* 32ch - 6254, 8ch-6123 Max Channel number of DAQ unit ,but mmwi used from 4ch to 2ch because Not Ready FIR   */	
#define INIT_SAMPLE_RATE		10000		// Hz
#define INIT_SAMPLE_RATE_LIMIT		15000		// Hz, for NI6220 Device. It's depends on device and channel 
#define INIT_MAX_CHAN_SAMPLES  		500000  /* first value : 100,000 but PXI-6123 Max Rate : 500,000 Hz. so number of sampling data per channel  */
...
typedef struct {
	...
	ST_NI6123_channel ST_Ch[INIT_MAX_CHAN_NUM];
...
extern float64 getTotSampsChan (ST_NI6123 *pNI6123);
...
extern int processDensity (ST_NI6123 *pNI6123, int chNo);
extern int resetDeviceAll ();

extern int processTrendRun ();
extern int processCalcRun ();

#endif	// _NB1A_DRV_NI6123_H
