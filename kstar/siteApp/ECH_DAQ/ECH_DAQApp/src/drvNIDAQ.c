...
/* TGLee change from INIT_SAMPLE_RATE to chanNum(ellCount) */
    ...
    //SCXI	sprintf (pNIDAQ->ST_Ch[i].physical_channel, "%s", pSTDCh->strArg2);
	...
	pNIDAQ->terminal_config			= DAQmx_Val_RSE;	// DAQmx_Val_Diff(6133,6259), DAQmx_Val_NRSE NI-6254&NI6220(DAQmx_Val_RSE)
