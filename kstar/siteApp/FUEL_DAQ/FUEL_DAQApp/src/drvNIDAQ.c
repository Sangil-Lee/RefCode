...
// This function not necessery to me , DAQmxTaskControl 2012.09.18
//		NIERROR(DAQmxTaskControl(pNIDAQ->taskHandle, DAQmx_Val_Task_Abort));  To use task state transitions model - power users
