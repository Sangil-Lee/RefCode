...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"GCDS_SHOT_NUMBER"
#define PV_SYS_ARMING_STR 		"GCDS_SYS_ARMING"
#define PV_SYS_RUN_STR			"GCDS_SYS_RUN"
#define PV_LTU_TIG_T0_STR		"FUEL2_LTU_P0_SEC0_T0"
#define PV_START_TIG_T0_STR		"GCDS_START_T0_SEC1"
#define PV_STOP_TIG_T1_STR		"GCDS_STOP_T1_SEC1"
#define PV_RESET_STR 			"GCDS_RESET"

#define PV_CALC_RUN_STR 		"GCDS_CALC_RUN"
#define PV_TREND_RUN_STR 		"GCDS_TREND_RUN"
#define PV_DAQ_STOP_STR 		"GCDS_DAQ_STOP"
...
#define INIT_MAX_CHAN_NUM		16	/* 32ch - 6254, 8ch-DAQ Max Channel number of DAQ unit ,but mmwi used from 4ch to 2ch because Not Ready FIR   */	
