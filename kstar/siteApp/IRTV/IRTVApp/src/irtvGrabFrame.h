...
extern CyResult CallbackFunction (void *aApp, CyDevice::CallbackId aId, unsigned long aTimeStamp, CyDevice::InterruptStatus aStatus);
...
public :
	...
	static void setCameraStatusWithHeader (ST_IRTV *pIRTV, iacfSHeader *pHeader);

	static void printCameraHeader (iacfSHeader *pHeader);
...
private :
	...
	CyXMLDocument		*lDocument;
    CyImageBuffer		*lBuffer;
	iacfSObjectParameters	*pObjParam;
...
private :
	...
	iacfSObjectParameters *getObjParam ();
