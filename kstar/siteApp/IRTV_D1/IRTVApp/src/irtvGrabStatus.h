...
typedef struct {
	...
	double		ao_trigger_mode;		// $(SYS)_TRIGGER_MODE
	...
	double		ai_sts_front_temp;		// $(SYS)_STATUS_FRONT_TEMP
	double		ai_sts_airgap_temp;		// $(SYS)_STATUS_AIRGAP_TEMP
	double		ai_sts_internal_temp;	// $(SYS)_STATUS_INTERNAL_TEMP
	...
	//
	double		ao_gain_level;			// $(SYS)_GAIN_LEVEL
	...
	int			bo_gen_seq_file;		// $(SYS)_GEN_SEQ_FILE
	int			bo_gen_tiff_file;		// $(SYS)_GEN_TIFF_FILE
	int			bo_gen_avi_file;		// $(SYS)_GEN_AVI_FILE
	int			bo_conn_enable;			// $(SYS)_CONN_ENABLE
...
extern int isCamConnected ();
extern int isIpMinFault ();
