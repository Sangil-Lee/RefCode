...
writeAoMdsplus(void *prec)
{
    ...
    case 1:
        ...
        break;
	case 2:  /* RF CTRL. T0 set */
		lhcd_rfctrl.t0 = pao->val;
		printf("RF CTRL. T0 : %f\n", lhcd_rfctrl.t0);
		break;
	case 3:  /* RF ANT. T0 set */
		lhcd_rfant.t0 = pao->val;
		printf("RF ANT. T0 : %f\n", lhcd_rfant.t0);
		break;
    }
    ...
    case 0:
        if(pbo->val == 1) {
            ...
            if(KstarMode) {
				...
				lhcd_rfctrl.shot = Mds_LocalShot;
            }
            mds_createNewShot(mdsShot, "lhcd1");
            epicsPrintf("*** mds_createNewShot OK ***\n");
        }
        break;
    case 1:
        if(pbo->val == 1) {
...
writeAoGain(void *prec)
{
    ...
    switch(addr) {
    case 0: /* NI PCI 6254 */
        daq6254pvt.gain[num] = pao->val;
        break;
    case 1: /* NI PCI 6220 */
        daq6220pvt.gain[num] = pao->val;
        break;
    }
...
writeAoOffset(void *prec)
{
    ...
    switch(addr) {
    case 0: /* NI PCI 6254 */
        daq6254pvt.offset[num] = pao->val;
        break;
    case 1: /* NI PCI 6220 */
        daq6220pvt.offset[num] = pao->val;
        break;
    }
...
readAiPowerCalc(void *prec)
{
    ...
    if(pai->pact) {
        ...
        case 0: /* Power */
            ...
            break;
        case 1: /* Integral */
            pai->val = daqIntegral.integral_val[num];
            break;
        }
