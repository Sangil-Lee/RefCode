...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"MMWI_SHOT_NUMBER"
#define PV_SYS_ARMING_STR 		"MMWI_SYS_ARMING"
#define PV_SYS_RUN_STR			"MMWI_SYS_RUN"
#define PV_LTU_TIG_T0_STR		"HALPHA_LTU_T0_p3"
#define PV_START_TIG_T0_STR		"MMWI_START_T0_SEC1"
#define PV_STOP_TIG_T1_STR		"MMWI_STOP_T1_SEC1"
#define PV_RESET_STR 			"MMWI_RESET"

#define PV_CALC_RUN_STR 		"MMWI_CALC_RUN"
#define PV_TREND_RUN_STR 		"MMWI_TREND_RUN"
#define PV_DAQ_STOP_STR 		"MMWI_DAQ_STOP"

// initial value
#define INIT_CHECK_INTERVAL			1       /* Interval for Check the Configuration in run as second */
#define INIT_MAX_CHAN_NUM			2	/* 32ch - 6254, 8ch-6123 Max Channel number of DAQ unit ,but mmwi used from 4ch to 2ch because Not Ready FIR   */	
