#!../../bin/linux-x86/PMS 
#export EPICS_CA_ADDR_LIST="172.17.101.159" RM TG - 20120713
epicsEnvSet("EPICS_CA_ADDR_LIST","172.17.101.159")
...
##############
# CWF PLC  pvMove from PMS to CWF 20110617
##############
...
dbLoadTemplate("db/PMS_IVCC_OUT_TEMP.template")
dbLoadTemplate("db/PMS_VV_TEMP.template")
dbLoadTemplate("db/PMS_MAX.template")
dbLoadTemplate("db/PMS_IVCC_MAX.template")
# remove 20110628 because CWF
...
seq PMSMAX, "FNAME=PMS_IVCC_F00.inp"
seq PMSMAX, "FNAME=PMS_IVCC_J00.inp"

epicsThreadSleep(2.)
seq PMSMAX, "FNAME=PMS_IVCC_CABLE.inp"
seq PMSMAX, "FNAME=PMS_IVCC_COIL.inp"
seq PMSMAX, "FNAME=PMS_NB_ALL.inp"
seq PMSMAX, "FNAME=PMS_ALL.inp"
