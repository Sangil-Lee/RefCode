...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"SMBI_DAQ_SHOT_NUMBER"
#define PV_SYS_ARMING_STR 		"SMBI_DAQ_SYS_ARMING"
#define PV_SYS_RUN_STR 			"SMBI_DAQ_SYS_RUN"
#define PV_RESET_STR 			"SMBI_DAQ_RESET"

#define PV_CALC_RUN_STR 		"SMBI_DAQ_CALC_RUN"
#define PV_TREND_RUN_STR 		"SMBI_DAQ_TREND_RUN"
#define PV_DAQ_STOP_STR 		"SMBI_DAQ_DAQ_STOP"

// initial value
#define INIT_CHECK_INTERVAL			1       /* Interval for Check the Configuration in run as second */
#define INIT_MAX_CHAN_NUM			6	/* 32ch - 6254, 8ch-6123 Max Channel number of DAQ unit ,but SMBI MGI  used 6ch   */	
