...
// PVs
#define PV_LOCAL_SHOT_NUMBER_STR 	"SXR_AI_SHOT_NUMBER"
#define PV_SYS_ARMING_STR			"SXR_AI_SYS_ARMING"
#define PV_SYS_RUN_STR				"SXR_AI_SYS_RUN"
#define PV_START_TIG_T0_STR			"SXR_AI_START_T0_SEC1"
#define PV_STOP_TIG_T1_STR			"SXR_AI_STOP_T1_SEC1"
#define PV_RESET_STR				"SXR_AI_RESET"

#define PV_CALC_RUN_STR				"SXR_AI_CALC_RUN"
#define PV_TREND_RUN_STR			"SXR_AI_TREND_RUN"
#define PV_DAQ_STOP_STR				"SXR_AI_DAQ_STOP"

// PVs for param
#define PV_SXR_AO_OUTPUT_VALUE_PWR_CH0_STR "SXR_AO_OUTPUT_VALUE_PWR_CH0"
#define PV_SXR_AO_OUTPUT_VALUE_CH0_STR 	   "SXR_AO_OUTPUT_VALUE_CH0"
#define PV_SXR_AO_OUTPUT_VALUE_CH1_STR 	   "SXR_AO_OUTPUT_VALUE_CH1"
#define PV_SXR_AO_OUTPUT_VALUE_CH2_STR 	   "SXR_AO_OUTPUT_VALUE_CH2"
#define PV_SXR_AO_OUTPUT_VALUE_CH3_STR 	   "SXR_AO_OUTPUT_VALUE_CH3"

// initial value
#define INIT_CHECK_INTERVAL		1       /* Interval for Check the Configuration in run as second */
#define INIT_MAX_CHAN_NUM		8	/* PCIe-6259 diff-16, single-32, 32ch - 6254, 8ch-DAQ Max Channel number of DAQ unit ,but mmwi used from 4ch to 2ch because Not Ready FIR , SCXI for STRAIN = 8x4=32  */	
...
typedef struct {
	...
	//	remove density float64		calcDensity[INIT_MAX_CHAN_SAMPLES];	        // buffer for density data
	// remove fScaleReadChannel float64		fScaleReadChannel[INIT_MAX_CHAN_SAMPLES];	// buffer for scaling sampling data of channel data
