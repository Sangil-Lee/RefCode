...
#define INIT_GAIN_CERNOX        1000.    /* 100 -> 1000 changed by TGLee 20090806, 100 -> 1000 changed at 080722*/
...
typedef struct {
	...
	unsigned short  channelStatus;
        ...
        int	        gainException;  /* 2012.4.23 -Cernox Type change CU -> AA, It is overRange(+/-5V) when temp is 5.5K with 100gain. To avoide overRange cernox type AA have to set gain 50.  */
        float64         gain;
	float64		cutOffFreq;
