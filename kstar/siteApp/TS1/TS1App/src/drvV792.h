...
#define STR_CHANNEL_RAW_DIR   "/data/rawTemp"
#define STR_CHANNEL_DATA_DIR   "/data/qtpData"
#define STR_Te_DATA_DIR   "/data/Te"
#define STR_K2_DATA_DIR   "/data/K2"



#define CH_CNT_MAX			32
