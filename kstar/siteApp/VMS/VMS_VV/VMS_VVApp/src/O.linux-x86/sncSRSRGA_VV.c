/* SNC Version 2.0.11: Tue Jan 12 17:02:56 2010: ../sncSRSRGA_VV.stt */
...
{
# line 85 "../sncSRSRGA_VV.stt"
# line 90 "../sncSRSRGA_VV.stt"
}
...
{
# line 111 "../sncSRSRGA_VV.stt"
	seq_delayInit(ssId, 0, (2.0));
# line 120 "../sncSRSRGA_VV.stt"
...
# line 109 "../sncSRSRGA_VV.stt"
	...
	case 1:
		{
# line 117 "../sncSRSRGA_VV.stt"
			for ((pVar->i) = 0; (pVar->i) < 13; (pVar->i)++)
			{
				(pVar->PvScan)[(pVar->i)] = 0;
				seq_pvPut(ssId, 0 /* PvScan */ + ((pVar->i)), 0);
			}
# line 118 "../sncSRSRGA_VV.stt"
			printf("FL_READ = %lf  \n", (pVar->FL_READ));
			printf("SCAN Passive !! \n");
		}
		return;
...
{
# line 140 "../sncSRSRGA_VV.stt"
# line 145 "../sncSRSRGA_VV.stt"
# line 152 "../sncSRSRGA_VV.stt"
}
...
static void A_SRSRGA_FIL_ON(SS_ID ssId, struct UserVar *pVar, short transNum)
{
	...
	case 0:
		{
# line 126 "../sncSRSRGA_VV.stt"
			(pVar->FL_0) = 1;
			seq_pvPut(ssId, 16 /* FL_0 */, 0);
# line 132 "../sncSRSRGA_VV.stt"
			for ((pVar->i) = 0; (pVar->i) < 13; (pVar->i)++)
			{
				(pVar->PvScan)[(pVar->i)] = 0;
				seq_pvPut(ssId, 0 /* PvScan */ + ((pVar->i)), 0);
			}
# line 133 "../sncSRSRGA_VV.stt"
			(pVar->CDEM_0) = 1;
...
{
# line 171 "../sncSRSRGA_VV.stt"
# line 177 "../sncSRSRGA_VV.stt"
}
...
static void A_SRSRGA_CDEM_ON(SS_ID ssId, struct UserVar *pVar, short transNum)
{
	...
	case 0:
		{
# line 157 "../sncSRSRGA_VV.stt"
			(pVar->FL_0) = 1;
			seq_pvPut(ssId, 16 /* FL_0 */, 0);
# line 163 "../sncSRSRGA_VV.stt"
			for ((pVar->i) = 0; (pVar->i) < 13; (pVar->i)++)
			{
				(pVar->PvScan)[(pVar->i)] = 0;
				seq_pvPut(ssId, 0 /* PvScan */ + ((pVar->i)), 0);
			}
# line 164 "../sncSRSRGA_VV.stt"
			(pVar->CDEM_0) = 1;
			seq_pvPut(ssId, 18 /* CDEM_0 */, 0);
			(pVar->CDEM_ON) = 0;
			seq_pvPut(ssId, 13 /* CDEM_ON */, 0);
...
{
# line 196 "../sncSRSRGA_VV.stt"
# line 202 "../sncSRSRGA_VV.stt"
}
...
static void A_SRSRGA_CDEM_OFF(SS_ID ssId, struct UserVar *pVar, short transNum)
{
	...
	case 0:
		{
# line 182 "../sncSRSRGA_VV.stt"
			(pVar->FL_0) = 1;
			seq_pvPut(ssId, 16 /* FL_0 */, 0);
# line 188 "../sncSRSRGA_VV.stt"
			for ((pVar->i) = 0; (pVar->i) < 13; (pVar->i)++)
			{
				(pVar->PvScan)[(pVar->i)] = 0;
				seq_pvPut(ssId, 0 /* PvScan */ + ((pVar->i)), 0);
			}
# line 189 "../sncSRSRGA_VV.stt"
			(pVar->FL_READ_ACT) = 1;
			seq_pvPut(ssId, 19 /* FL_READ_ACT */, 0);
			(pVar->CDEM_0) = 1;
			seq_pvPut(ssId, 18 /* CDEM_0 */, 0);
...
static struct seqChan seqChan[NUM_CHANNELS] = {
  {"VMS_VV_RGA_M2_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[0]), "PvScan[0]", 
    "short", 1, 1, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M4_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[1]), "PvScan[1]", 
    "short", 1, 2, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M12_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[2]), "PvScan[2]", 
    "short", 1, 3, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M18_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[3]), "PvScan[3]", 
    "short", 1, 4, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M28_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[4]), "PvScan[4]", 
    "short", 1, 5, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M32_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[5]), "PvScan[5]", 
    "short", 1, 6, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M40_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[6]), "PvScan[6]", 
    "short", 1, 7, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M44_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[7]), "PvScan[7]", 
    "short", 1, 8, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M16_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[8]), "PvScan[8]", 
    "short", 1, 9, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M20_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[9]), "PvScan[9]", 
    "short", 1, 10, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M26_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[10]), "PvScan[10]", 
    "short", 1, 11, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_M3_ION.SCAN", (void *)OFFSET(struct UserVar, PvScan[11]), "PvScan[11]", 
    "short", 1, 12, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_FL_ON", (void *)OFFSET(struct UserVar, FL_ON), "FL_ON", 
    "int", 1, 13, 0, 1, 0, 0, 0},

  {"VMS_VV_RGA_CDEM_ON", (void *)OFFSET(struct UserVar, CDEM_ON), "CDEM_ON", 
    "int", 1, 14, 0, 1, 0, 0, 0},

  {"VMS_VV_RGA_FL", (void *)OFFSET(struct UserVar, FL_READ), "FL_READ", 
    "float", 1, 15, 0, 1, 0, 0, 0},

  {"VMS_VV_RGA_FL_1.PROC", (void *)OFFSET(struct UserVar, FL_1), "FL_1", 
    "int", 1, 16, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_FL_0.PROC", (void *)OFFSET(struct UserVar, FL_0), "FL_0", 
    "int", 1, 17, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_CDEM_1.PROC", (void *)OFFSET(struct UserVar, CDEM_1), "CDEM_1", 
    "int", 1, 18, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_CDEM_0.PROC", (void *)OFFSET(struct UserVar, CDEM_0), "CDEM_0", 
    "int", 1, 19, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_FL.PROC", (void *)OFFSET(struct UserVar, FL_READ_ACT), "FL_READ_ACT", 
    "int", 1, 20, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_ID.PROC", (void *)OFFSET(struct UserVar, ID), "ID", 
    "int", 1, 21, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_IN0.PROC", (void *)OFFSET(struct UserVar, IN0), "IN0", 
    "int", 1, 22, 0, 0, 0, 0, 0},

  {"VMS_VV_RGA_CA.PROC", (void *)OFFSET(struct UserVar, CA), "CA", 
    "int", 1, 23, 0, 0, 0, 0, 0},
