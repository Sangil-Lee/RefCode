...
/* Add Version - 0.2 Function  2010.11.20 */
AT_EXP_MOD AT_U32 AT_EXP_CONV ATSIF_GetPixelCalibration(ATSIF_DataSource _source, AT_32 _i_pixel, double * _d_calibValue);
