...
dbLoadTemplate "db/XXX_CLTU_CFG.template"           /* only NEW */
dbLoadTemplate "db/XXX_MTRIG_P0_CFG.template"       /* for many trigger on port 0 */
dbLoadTemplate "db/XXX_MTRIG_P1_CFG.template"       /* for many trigger on port 1 */
