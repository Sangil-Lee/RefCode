/* $Id: devSequencer.c,v 1.1.1.1 2007/04/20 00:32:03 khkim Exp $
 *
...
#define SETTLE_TIME_FOR_INIT        0.50
#define INTERVAL_FOR_SCAN_LOOP      0.25
...
LOCAL void devSeqScanThread(void)
{
    ...
    while(!pdevSeqScanList->count) {
        epicsThreadSleep(SETTLE_TIME_FOR_INIT);
    }
    ...
    while(TRUE) {
        ...
        epicsThreadSleep(INTERVAL_FOR_SCAN_LOOP);
    }
}
 ...
 * Revision 1.1.1.1  2007/04/20 00:32:03  khkim
 * initial import for R3.14.8.2
 *
 * Revision 1.2  2004/06/21 15:28:56  khkim
 * insert settle time waiting in intializing
 *
 *
