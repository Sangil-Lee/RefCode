...
#define T(fmt, args...) printk(KERN_DEBUG "intLTU_core:" fmt, ## args)
#define E(fmt, args...) printk(KERN_NOTICE "intLTU_core:" fmt, ## args)
...
#define DBG_FIRED(lvl)  (intLTU_debug>=(lvl) || LOCAL_DEBUG>=(lvl))
