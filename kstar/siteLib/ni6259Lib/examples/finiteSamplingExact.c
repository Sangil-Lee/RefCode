/*************************************************************************
 * $HeadURL: https://svnpub.iter.org/codac/iter/codac/dev/units/m-kmod-pxi6259/branches/codac-core-4.1/src/main/c/examples/finiteSamplingExact.c $
 * $Id: finiteSamplingExact.c 34216 2013-02-20 09:00:23Z cesnikt $
 *
 ...
 * The example configures 1 kHz sampling rate and then it instructs
 * driver to acquire only a user-configurable number of samples.
 * It then uses pxi6259_read_ai_exact to read all samples at once.
 */
...
int main(int argc, char** argv) {
        ...
        // use pxi6259_read_ai_exact to read all samples at once
        n_read_samples = pxi6259_read_ai_exact(channel,buffer,n_samples,0,1000);
        if (n_read_samples < 0) {
