...
LOCAL void drvTPG262_read(asynUser* pasynTPG262User)
{
    ...
    pasynTPG262Octet->setEos(pdrvPvt, pasynTPG262User, EOS_STR, 2);

    pasynTPG262Octet->write(pdrvPvt, pasynTPG262User, "PRX"EOS_STR, 5);
    pasynTPG262Octet->read(pdrvPvt, pasynTPG262User, dumBuf,TPG262_DUMBUFSIZE);
    pasynTPG262Octet->write(pdrvPvt, pasynTPG262User, ENQ_STR, 1);
    i=pasynTPG262Octet->read(pdrvPvt, pasynTPG262User, msgBuf, TPG262_MSGBUFSIZE);
...
LOCAL void drvTPG262_setUnit(asynUser* pasynTPG262User)
{
    ...
    pasynTPG262Octet->write(pdrvPvt, pasynTPG262User, msgBuf, strlen(msgBuf));
    pasynTPG262Octet->read(pdrvPvt, pasynTPG262User, dumBuf,TPG262_DUMBUFSIZE);
    pasynTPG262Octet->write(pdrvPvt, pasynTPG262User, ENQ_STR, 1);
    pasynTPG262Octet->read(pdrvPvt, pasynTPG262User, msgBuf, TPG262_MSGBUFSIZE);
