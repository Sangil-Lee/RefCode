#ifndef SDN_TOPIC1E_TEST_H
#define SDN_TOPIC1E_TEST_H

#include "sdn/sdn_typedef.h"

#define	topic1e_test	topic1e_test_metadata,topic1e_test_userdata
...
class PACKED topic1e_test_userdata {
	public:
...
class topic1e_test_metadata
{
#define	_TOPIC1E_TEST_NAME			"topic1e_test"
#define	_TOPIC1E_TEST_DESCRIPTION	"This is a topic definition file for topic1e_test event."
#define	_TOPIC1E_TEST_VERSION		1
#define	_TOPIC1E_TEST_EVENT			1

	public:
		topic1e_test_metadata()
		{
			name = _TOPIC1E_TEST_NAME;
			description = _TOPIC1E_TEST_DESCRIPTION;
			version = _TOPIC1E_TEST_VERSION;
			payloadsize = sizeof(topic1e_test_userdata);
			is_event = _TOPIC1E_TEST_EVENT;
