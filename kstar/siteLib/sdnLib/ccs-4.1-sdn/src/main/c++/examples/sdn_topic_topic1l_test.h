#ifndef SDN_TOPIC1L_TEST_H
#define SDN_TOPIC1L_TEST_H

#include "sdn/sdn_typedef.h"

#define	topic1l_test	topic1l_test_metadata,topic1l_test_userdata
...
class PACKED topic1l_test_userdata {
	public:
...
class topic1l_test_metadata
{
#define	_TOPIC1L_TEST_NAME			"topic1l_test"
#define	_TOPIC1L_TEST_DESCRIPTION	"This is a topic definition file for topic1l_test."
#define	_TOPIC1L_TEST_VERSION		1
#define	_TOPIC1L_TEST_EVENT			0

	public:
		topic1l_test_metadata()
		{
			name = _TOPIC1L_TEST_NAME;
			description = _TOPIC1L_TEST_DESCRIPTION;
			version = _TOPIC1L_TEST_VERSION;
			payloadsize = sizeof(topic1l_test_userdata);
			is_event = _TOPIC1L_TEST_EVENT;
