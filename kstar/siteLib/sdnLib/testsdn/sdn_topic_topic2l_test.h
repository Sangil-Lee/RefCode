#ifndef SDN_TOPIC2L_TEST_H
#define SDN_TOPIC2L_TEST_H

#include "sdn/sdn_typedef.h"

#define	topic2l_test	topic2l_test_metadata,topic2l_test_userdata
...
class PACKED topic2l_test_userdata {
	public:
...
class topic2l_test_metadata
{
#define	_TOPIC2L_TEST_NAME			"topic2l_test"
#define	_TOPIC2L_TEST_DESCRIPTION	"This is a topic definition file for topic2l_test."
#define	_TOPIC2L_TEST_VERSION		1
#define	_TOPIC2L_TEST_EVENT			0

	public:
		topic2l_test_metadata()
		{
			name = _TOPIC2L_TEST_NAME;
			description = _TOPIC2L_TEST_DESCRIPTION;
			version = _TOPIC2L_TEST_VERSION;
			payloadsize = sizeof(topic2l_test_userdata);
			is_event = _TOPIC2L_TEST_EVENT;
