    ...
    /* sprintf(pStringIn->val,"ala %d",get_uptime()); */
      ...
      else
	  {
		  if(!strcmp(pvmeio->parm,"SYSNAME"))
			  ...
			  // 32bits : #1 SMP Tue Mar 16 21:52:43 EDT 2010 i686 i686 i386 GNU/Linux
			  // 64bits MRG-R : #1 SMP PREEMPT RT Wed Dec 5 10:16:39 CET 2012 x86_64 x86_64 x86_64 GNU/Linux
			  snprintf(pStringIn->val, sizeof(pStringIn->val)-1, "%s",name.version);
